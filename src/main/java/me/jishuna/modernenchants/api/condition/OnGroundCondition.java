...
public class OnGroundCondition extends EnchantmentCondition {

	private final ActionTarget target;
	private final boolean bool;

	public OnGroundCondition(String[] data) throws InvalidEnchantmentException {
		super(data);
		checkLength(data, 2);
	...
	public boolean check(EnchantmentContext context, CustomEnchantment enchant) {
		...
		return entity.getLocation().subtract(0, 0.1, 0).getBlock().getType().isAir() != bool;
	}
}
